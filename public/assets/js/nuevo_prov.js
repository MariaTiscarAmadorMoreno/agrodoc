console.log("nuevo_prov.js cargado correctamente");
...
form.addEventListener('submit', function (e) {
    ...
    if (!apellidos) {
        document.getElementById('errorApellidos').textContent = "Los apellidos son abligatorios.";
        hayErrores = true;
    }
    ...
    //enviar los datos
    const formData = { nombre, apellidos, cif, email, telefono, direccion };
    console.log (formData);

    fetch('/controllers/ProvController.php?action=crearProveedor', {
        method: 'POST',
        headers: {
